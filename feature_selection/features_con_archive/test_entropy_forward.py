...
file_sel = open("data/features_sel_forward_entropy.csv","wb")
file_writer = csv.writer(file_sel)

file_writer.writerow(["Loop Index","Entropy Value","Added Feature Index",\
        "Added Feature Name"])
...
plt.title("Forward Search With Entropy Metric")
plt.show()
