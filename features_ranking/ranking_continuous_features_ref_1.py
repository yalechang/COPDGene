"""This script rank features according their HSICs with GOLD using training set
    1) Get HSIC/NormalizedHSIC values for each feature
    2) Rank features according to NHSIC value
"""
